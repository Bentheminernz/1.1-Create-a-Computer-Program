...
def format_questions(questionInfo):      # Formats questions and gets users answer
...
def quiz(questions):
    ...
    for question_info in questions:
        ...
        if user_answer == correct_answer:
            ...
            print(f"You got it wrong, better luck next time! The correct answer was '{correct_answer}'")
